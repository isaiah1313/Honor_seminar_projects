...
\begin{frame}{特殊相対性理論の復習}
    \begin{block}{慣性系}
        慣性の法則が成立する観測系のこと。

        異なる慣性系では同じ物理法則が成立する理論を作る.

        ある慣性系から見た時空の点は$x^\mu = [ct,x,y,z]$で表す.

        他の慣性系から見た時空の一点は$x'^\mu=\tensor{\Lambda}{^\mu_\nu}x^\nu$で変換する。
    \end{block}
\end{frame}

\begin{frame}{特殊相対性理論の拡張}
    \begin{block}{特殊相対性理論}
