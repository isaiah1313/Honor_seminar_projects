...
\begin{frame}{一般相対論の舞台:接続}
\end{frame}

\begin{frame}{一般相対論の舞台:リーマン曲率テンソル}
\end{frame}

\begin{frame}{一般相対論の舞台:曲率テンソル}
\end{frame}
...
\begin{frame}{時空を決定する作用}
\end{frame}

\begin{frame}{時空の運動方程式}
\end{frame}
